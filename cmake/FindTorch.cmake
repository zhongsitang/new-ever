...
target_compile_options(Torch::Torch INTERFACE
  $<$<COMPILE_LANG_AND_ID:CXX,MSVC>:${COMMON_MSVC_FLAGS}>
  $<$<COMPILE_LANG_AND_ID:CUDA,MSVC>:${WIN_CUDA_FLAGS}>
  $<$<COMPILE_LANG_AND_ID:CUDA,GNU,Clang,AppleClang>:${UNIX_CUDA_FLAGS}>
)
