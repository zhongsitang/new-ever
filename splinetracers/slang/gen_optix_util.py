...
def generate():
    lines = [
        ...
        "//",
        "// Built-in Slang intrinsics used instead of custom wrappers:",
        "//   HitKind()         - replaces optixGetHitKind()",
        "//   ReportHitOptix()  - replaces optixReportIntersection()",
        "//",
        "// This file provides custom intrinsics for dynamic payload access",
        "// and array-based trace, which are not covered by standard Slang intrinsics.",
        "",
        "// -----------------------------------------------------------------------------",
    ...
    lines.extend([
        "",
        "// Note: Use built-in ReportHitOptix(t, hitKind, attr0, ...) instead of",
        "// custom optixReportHit wrappers.",
        "",
        "// -----------------------------------------------------------------------------",
