...
#line 18 "E:/projects/multi-view-hair/code/volume_primitive/ever/splinetracers/slang/tensor-util.slang"
__device__ float3  get_float3_0(TensorView view_0, uint ind_0)
{
...
#line 19
    float _S3 = ((view_0).load<float>((ind_0), (2U)));
...
#line 42 "E:/projects/multi-view-hair/code/volume_primitive/ever/splinetracers/slang/tensor-util.slang"
__device__ float3  get_float3_1(TensorView view_1, uint ind_1, uint feat_ind_0)
{

#line 43
    float _S4 = ((view_1).load<float>((ind_1), (feat_ind_0), (0U)));

#line 43
    float _S5 = ((view_1).load<float>((ind_1), (feat_ind_0), (1U)));

#line 43
    float _S6 = ((view_1).load<float>((ind_1), (feat_ind_0), (2U)));

#line 43
    return make_float3 (_S4, _S5, _S6);
}
...
#line 113 "E:/projects/multi-view-hair/code/volume_primitive/ever/splinetracers/slang/tensor-util.slang"
__device__ Features_0 get_feats_0(TensorView features_0, uint prim_ind_0, uint sh_degree_0)
{

#line 114
    Features_0 feat_0;
    float3  _S7 = get_float3_1(features_0, prim_ind_0, 0U);
...
#line 117
        float3  _S8 = get_float3_1(features_0, prim_ind_0, 1U);

#line 117
        (&feat_0)->f1_0 = _S8;
        float3  _S9 = get_float3_1(features_0, prim_ind_0, 2U);

#line 118
        (&feat_0)->f2_0 = _S9;
        float3  _S10 = get_float3_1(features_0, prim_ind_0, 3U);
...
#line 121
            float3  _S11 = get_float3_1(features_0, prim_ind_0, 4U);

#line 121
            (&feat_0)->f4_0 = _S11;
            float3  _S12 = get_float3_1(features_0, prim_ind_0, 5U);

#line 122
            (&feat_0)->f5_0 = _S12;
            float3  _S13 = get_float3_1(features_0, prim_ind_0, 6U);

#line 123
            (&feat_0)->f6_0 = _S13;
            float3  _S14 = get_float3_1(features_0, prim_ind_0, 7U);

#line 124
            (&feat_0)->f7_0 = _S14;
            float3  _S15 = get_float3_1(features_0, prim_ind_0, 8U);
...
#line 127
                float3  _S16 = get_float3_1(features_0, prim_ind_0, 9U);

#line 127
                (&feat_0)->f9_0 = _S16;
                float3  _S17 = get_float3_1(features_0, prim_ind_0, 10U);

#line 128
                (&feat_0)->f10_0 = _S17;
                float3  _S18 = get_float3_1(features_0, prim_ind_0, 11U);

#line 129
                (&feat_0)->f11_0 = _S18;
                float3  _S19 = get_float3_1(features_0, prim_ind_0, 12U);

#line 130
                (&feat_0)->f12_0 = _S19;
                float3  _S20 = get_float3_1(features_0, prim_ind_0, 13U);

#line 131
                (&feat_0)->f13_0 = _S20;
                float3  _S21 = get_float3_1(features_0, prim_ind_0, 14U);

#line 132
                (&feat_0)->f14_0 = _S21;
                float3  _S22 = get_float3_1(features_0, prim_ind_0, 15U);
...
#line 1674
    (&result_3)->f0_0 = SLANG_anonymous_0_0.f0_0 + SLANG_anonymous_1_0.f0_0;

#line 1674
    (&result_3)->f1_0 = SLANG_anonymous_0_0.f1_0 + SLANG_anonymous_1_0.f1_0;

#line 1674
    (&result_3)->f2_0 = SLANG_anonymous_0_0.f2_0 + SLANG_anonymous_1_0.f2_0;

#line 1674
    (&result_3)->f3_0 = SLANG_anonymous_0_0.f3_0 + SLANG_anonymous_1_0.f3_0;

#line 1674
    (&result_3)->f4_0 = SLANG_anonymous_0_0.f4_0 + SLANG_anonymous_1_0.f4_0;

#line 1674
    (&result_3)->f5_0 = SLANG_anonymous_0_0.f5_0 + SLANG_anonymous_1_0.f5_0;

#line 1674
    (&result_3)->f6_0 = SLANG_anonymous_0_0.f6_0 + SLANG_anonymous_1_0.f6_0;

#line 1674
    (&result_3)->f7_0 = SLANG_anonymous_0_0.f7_0 + SLANG_anonymous_1_0.f7_0;

#line 1674
    (&result_3)->f8_0 = SLANG_anonymous_0_0.f8_0 + SLANG_anonymous_1_0.f8_0;

#line 1674
    (&result_3)->f9_0 = SLANG_anonymous_0_0.f9_0 + SLANG_anonymous_1_0.f9_0;

#line 1674
    (&result_3)->f10_0 = SLANG_anonymous_0_0.f10_0 + SLANG_anonymous_1_0.f10_0;

#line 1674
    (&result_3)->f11_0 = SLANG_anonymous_0_0.f11_0 + SLANG_anonymous_1_0.f11_0;

#line 1674
    (&result_3)->f12_0 = SLANG_anonymous_0_0.f12_0 + SLANG_anonymous_1_0.f12_0;

#line 1674
    (&result_3)->f13_0 = SLANG_anonymous_0_0.f13_0 + SLANG_anonymous_1_0.f13_0;

#line 1674
    (&result_3)->f14_0 = SLANG_anonymous_0_0.f14_0 + SLANG_anonymous_1_0.f14_0;

#line 1674
    (&result_3)->f15_0 = SLANG_anonymous_0_0.f15_0 + SLANG_anonymous_1_0.f15_0;
...
#line 67
    ...
    return make_float3 (1.09254848957061768f * (x_3 * y_1)) * feat_3.f4_0 + make_float3 (-1.09254848957061768f * (y_1 * z_0)) * feat_3.f5_0 + make_float3 (0.31539157032966614f * (2.0f * (z_0 * z_0) - xx_0 - yy_0)) * feat_3.f6_0 + make_float3 (-1.09254848957061768f * (x_3 * z_0)) * feat_3.f7_0 + make_float3 (0.54627424478530884f * (xx_0 - yy_0)) * feat_3.f8_0;
}
...
#line 79
    ...
    float _S24 = 3.0f * xx_1;

    float _S25 = 4.0f * zz_0 - xx_1 - yy_1;
    float _S26 = 3.0f * yy_1;

#line 81
    return make_float3 (-0.59004360437393188f * y_2 * (_S24 - yy_1)) * feat_4.f9_0 + make_float3 (2.89061141014099121f * (x_4 * y_2) * z_1) * feat_4.f10_0 + make_float3 (-0.4570457935333252f * y_2 * _S25) * feat_4.f11_0 + make_float3 (0.37317633628845215f * z_1 * (2.0f * zz_0 - _S24 - _S26)) * feat_4.f12_0 + make_float3 (-0.4570457935333252f * x_4 * _S25) * feat_4.f13_0 + make_float3 (1.44530570507049561f * z_1 * (xx_1 - yy_1)) * feat_4.f14_0 + make_float3 (-0.59004360437393188f * x_4 * (xx_1 - _S26)) * feat_4.f15_0;
}
...
#line 21 "E:/projects/multi-view-hair/code/volume_primitive/ever/splinetracers/slang/sh_kernel.slang"
__global__ void __kernel__sh_kernel(TensorView means_0, TensorView features_1, TensorView ray_origin_0, TensorView colors_0, uint sh_degree_2)
{

#line 29
    uint prim_ind_1 = (((threadIdx)) + ((blockIdx)) * ((blockDim))).x;
    float _S27 = ((ray_origin_0).load<float>((0U)));

#line 30
    float _S28 = ((ray_origin_0).load<float>((1U)));

#line 30
    float _S29 = ((ray_origin_0).load<float>((2U)));

#line 30
    float3  rayo_0 = make_float3 (_S27, _S28, _S29);

    uint _S30 = ((means_0).sizes[(0U)]);
...
#line 33
    ...
    float3  mean_0 = get_float3_0(means_0, prim_ind_1);

    float3  dir_pp_0 = normalize_0(mean_0 - rayo_0);
    Features_0 feat_6 = get_feats_0(features_1, prim_ind_1, sh_degree_2);
    float3  color_4 = eval_color_0(dir_pp_0, feat_6, sh_degree_2);
    (colors_0).store<float>((prim_ind_1), (0U), (color_4.x));
    (colors_0).store<float>((prim_ind_1), (1U), (color_4.y));
    (colors_0).store<float>((prim_ind_1), (2U), (color_4.z));
    return;
}


#line 72 "E:/projects/multi-view-hair/code/volume_primitive/ever/splinetracers/slang/tensor-util.slang"
__device__ void add_float3_0(TensorView view_2, uint ind_2, uint feat_ind_1, float3  val_0)
{

#line 73
    float _S31 = ((view_2).load<float>((ind_2), (feat_ind_1), (0U)));

#line 73
    (view_2).store<float>((ind_2), (feat_ind_1), (0U), (_S31 + val_0.x));
    float _S32 = ((view_2).load<float>((ind_2), (feat_ind_1), (1U)));

#line 74
    (view_2).store<float>((ind_2), (feat_ind_1), (1U), (_S32 + val_0.y));
    float _S33 = ((view_2).load<float>((ind_2), (feat_ind_1), (2U)));

#line 75
    (view_2).store<float>((ind_2), (feat_ind_1), (2U), (_S33 + val_0.z));
    return;
}


#line 47 "E:/projects/multi-view-hair/code/volume_primitive/ever/splinetracers/slang/sh_kernel.slang"
...
__device__ void s_bwd_prop_eval_sh_col3_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * dpdir_0, DiffPair_Features_0 * dpfeat_0, float3  _s_dOut_0)
{

#line 76
    float x_5 = (*dpdir_0).primal_0.x;
...
#line 79
    ...
    float _S34 = -0.59004360437393188f * y_3;

#line 81
    float _S35 = 3.0f * xx_2;

#line 81
    float _S36 = _S35 - yy_2;
    float _S37 = 2.89061141014099121f * (x_5 * y_3);
    float _S38 = -0.4570457935333252f * y_3;

#line 83
    float _S39 = 4.0f * zz_1 - xx_2 - yy_2;
    float _S40 = 0.37317633628845215f * z_2;

#line 84
    float _S41 = 3.0f * yy_2;

#line 84
    float _S42 = 2.0f * zz_1 - _S35 - _S41;
    float _S43 = -0.4570457935333252f * x_5;
    float _S44 = 1.44530570507049561f * z_2;

#line 86
    float _S45 = xx_2 - yy_2;
    float _S46 = -0.59004360437393188f * x_5;

#line 87
    float _S47 = xx_2 - _S41;

#line 87
    float3  _S48 = make_float3 (_S46 * _S47) * _s_dOut_0;

#line 87
    float3  _S49 = (*dpfeat_0).primal_0.f15_0 * _s_dOut_0;

#line 87
    float _S50 = _S49.x + _S49.y + _S49.z;

#line 87
    float _S51 = _S46 * _S50;

#line 86
    float3  _S52 = make_float3 (_S44 * _S45) * _s_dOut_0;

#line 86
    float3  _S53 = (*dpfeat_0).primal_0.f14_0 * _s_dOut_0;

#line 86
    float _S54 = _S53.x + _S53.y + _S53.z;

#line 86
    float _S55 = _S44 * _S54;

#line 85
    float3  _S56 = make_float3 (_S43 * _S39) * _s_dOut_0;

#line 85
    float3  _S57 = (*dpfeat_0).primal_0.f13_0 * _s_dOut_0;

#line 85
    float _S58 = _S57.x + _S57.y + _S57.z;

#line 84
    float3  _S59 = make_float3 (_S40 * _S42) * _s_dOut_0;

#line 84
    float3  _S60 = (*dpfeat_0).primal_0.f12_0 * _s_dOut_0;

#line 84
    float _S61 = _S60.x + _S60.y + _S60.z;

#line 84
    float _S62 = _S40 * _S61;

#line 84
    float _S63 = - _S62;

#line 83
    float3  _S64 = make_float3 (_S38 * _S39) * _s_dOut_0;

#line 83
    float3  _S65 = (*dpfeat_0).primal_0.f11_0 * _s_dOut_0;

#line 83
    float _S66 = _S65.x + _S65.y + _S65.z;

#line 83
    float _S67 = _S43 * _S58 + _S38 * _S66;

#line 83
    float _S68 = - _S67;

#line 82
    float3  _S69 = make_float3 (_S37 * z_2) * _s_dOut_0;

#line 82
    float3  _S70 = (*dpfeat_0).primal_0.f10_0 * _s_dOut_0;

#line 82
    float _S71 = _S70.x + _S70.y + _S70.z;

#line 82
    float s_diff_xy_T_0 = 2.89061141014099121f * (z_2 * _S71);

#line 81
    float3  _S72 = make_float3 (_S34 * _S36) * _s_dOut_0;

#line 81
    float3  _S73 = (*dpfeat_0).primal_0.f9_0 * _s_dOut_0;

#line 81
    float _S74 = _S73.x + _S73.y + _S73.z;

#line 81
    float _S75 = _S34 * _S74;

#line 79
    float _S76 = z_2 * (2.0f * _S62 + 4.0f * _S67);

#line 79
    float _S77 = y_3 * (- _S55 + 3.0f * (- _S51 + _S63) + _S68 + - _S75);

#line 79
    float _S78 = x_5 * (_S51 + _S55 + _S68 + 3.0f * (_S63 + _S75));

#line 78
    float _S79 = 1.44530570507049561f * (_S45 * _S54) + 0.37317633628845215f * (_S42 * _S61) + _S37 * _S71 + _S76 + _S76;

#line 77
    float _S80 = -0.4570457935333252f * (_S39 * _S66) + -0.59004360437393188f * (_S36 * _S74) + x_5 * s_diff_xy_T_0 + _S77 + _S77;

#line 76
    float _S81 = -0.59004360437393188f * (_S47 * _S50) + -0.4570457935333252f * (_S39 * _S58) + y_3 * s_diff_xy_T_0 + _S78 + _S78;

#line 76
    Features_0 _S82 = Features_x24_syn_dzero_0();
...
#line 76
    dpfeat_0->differential_0 = _S82;

#line 76
    float3  _S83 = make_float3 (_S81, _S80, _S79);

#line 76
    dpdir_0->primal_0 = (*dpdir_0).primal_0;

#line 76
    dpdir_0->differential_0 = _S83;
...
#line 63
__device__ void s_bwd_prop_eval_sh_col2_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * dpdir_1, DiffPair_Features_0 * dpfeat_1, float3  _s_dOut_1)
{

#line 64
    float x_6 = (*dpdir_1).primal_0.x;
    float y_4 = (*dpdir_1).primal_0.y;
...
#line 67
    ...
    float3  _S84 = make_float3 (0.54627424478530884f * (xx_3 - yy_3)) * _s_dOut_1;

#line 71
    float3  _S85 = (*dpfeat_1).primal_0.f8_0 * _s_dOut_1;

#line 71
    float _S86 = 0.54627424478530884f * (_S85.x + _S85.y + _S85.z);

#line 71
    float3  _S87 = make_float3 (-1.09254848957061768f * (x_6 * z_3)) * _s_dOut_1;

#line 71
    float3  _S88 = (*dpfeat_1).primal_0.f7_0 * _s_dOut_1;

#line 71
    float s_diff_xz_T_0 = -1.09254848957061768f * (_S88.x + _S88.y + _S88.z);

#line 70
    float3  _S89 = make_float3 (0.31539157032966614f * (2.0f * (z_3 * z_3) - xx_3 - yy_3)) * _s_dOut_1;

#line 70
    float3  _S90 = (*dpfeat_1).primal_0.f6_0 * _s_dOut_1;

#line 70
    float _S91 = 0.31539157032966614f * (_S90.x + _S90.y + _S90.z);

#line 70
    float _S92 = - _S91;

#line 69
    float3  _S93 = make_float3 (-1.09254848957061768f * (y_4 * z_3)) * _s_dOut_1;

#line 69
    float3  _S94 = (*dpfeat_1).primal_0.f5_0 * _s_dOut_1;

#line 69
    float s_diff_yz_T_0 = -1.09254848957061768f * (_S94.x + _S94.y + _S94.z);

#line 69
    float3  _S95 = make_float3 (1.09254848957061768f * (x_6 * y_4)) * _s_dOut_1;

#line 69
    float3  _S96 = (*dpfeat_1).primal_0.f4_0 * _s_dOut_1;

#line 69
    float s_diff_xy_T_1 = 1.09254848957061768f * (_S96.x + _S96.y + _S96.z);

#line 67
    float _S97 = z_3 * (2.0f * _S91);

#line 67
    float _S98 = y_4 * (- _S86 + _S92);

#line 67
    float _S99 = x_6 * (_S86 + _S92);

#line 66
    float _S100 = x_6 * s_diff_xz_T_0 + y_4 * s_diff_yz_T_0 + _S97 + _S97;

#line 65
    float _S101 = z_3 * s_diff_yz_T_0 + x_6 * s_diff_xy_T_1 + _S98 + _S98;

#line 64
    float _S102 = z_3 * s_diff_xz_T_0 + y_4 * s_diff_xy_T_1 + _S99 + _S99;

#line 64
    Features_0 _S103 = Features_x24_syn_dzero_0();
...
#line 64
    dpfeat_1->differential_0 = _S103;

#line 64
    float3  _S104 = make_float3 (_S102, _S101, _S100);

#line 64
    dpdir_1->primal_0 = (*dpdir_1).primal_0;

#line 64
    dpdir_1->differential_0 = _S104;
...
__device__ void s_bwd_prop_eval_sh_col1_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * dpdir_2, DiffPair_Features_0 * dpfeat_2, float3  s_diff_color_T_0)
{
    ...
    float3  _S105 = - s_diff_color_T_0;

#line 58
    float3  _S106 = make_float3 (0.48860251903533936f * (*dpdir_2).primal_0.x) * _S105;

#line 58
    float3  _S107 = (*dpfeat_2).primal_0.f3_0 * _S105;

#line 58
    float s_diff_x_T_0 = 0.48860251903533936f * (_S107.x + _S107.y + _S107.z);

#line 58
    float3  _S108 = make_float3 (0.48860251903533936f * (*dpdir_2).primal_0.z) * s_diff_color_T_0;

#line 58
    float3  _S109 = (*dpfeat_2).primal_0.f2_0 * s_diff_color_T_0;

#line 58
    float s_diff_z_T_0 = 0.48860251903533936f * (_S109.x + _S109.y + _S109.z);

#line 58
    float3  _S110 = make_float3 (-0.48860251903533936f * (*dpdir_2).primal_0.y) * s_diff_color_T_0;

#line 58
    float3  _S111 = (*dpfeat_2).primal_0.f1_0 * s_diff_color_T_0;

#line 58
    float s_diff_y_T_0 = -0.48860251903533936f * (_S111.x + _S111.y + _S111.z);

#line 58
    Features_0 _S112 = Features_x24_syn_dzero_0();
...
#line 58
    dpfeat_2->differential_0 = _S112;

#line 58
    float3  _S113 = make_float3 (s_diff_x_T_0, s_diff_y_T_0, s_diff_z_T_0);

#line 58
    dpdir_2->primal_0 = (*dpdir_2).primal_0;

#line 58
    dpdir_2->differential_0 = _S113;
...
#line 49
__device__ void s_bwd_prop_eval_sh_col0_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * dpdir_3, DiffPair_Features_0 * dpfeat_3, float3  _s_dOut_2)
{

#line 50
    float3  _S114 = make_float3 (0.282094806432724f) * _s_dOut_2;

#line 50
    Features_0 _S115 = Features_x24_syn_dzero_0();
...
#line 91
__device__ void s_bwd_prop_eval_color_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * dpdir_4, DiffPair_Features_0 * dpfeat_4, uint sh_degree_3, float3  _s_dOut_3)
{

#line 91
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S117 = *dpdir_4;

#line 91
    DiffPair_Features_0 _S118 = *dpfeat_4;

    bool _S119 = sh_degree_3 > 0U;
...
#line 1674 "core.meta.slang"
    float3  _S124 = make_float3 (0.0f);

#line 1674
    Features_0 _S125 = Features_x24_syn_dzero_0();
...
#line 98
                (&_S128)->primal_0 = _S117.primal_0;

#line 98
                (&_S128)->differential_0 = _S124;

#line 98
                DiffPair_Features_0 _S129;

#line 98
                (&_S129)->primal_0 = _S118.primal_0;

#line 98
                (&_S129)->differential_0 = _S125;

#line 98
                s_bwd_prop_eval_sh_col3_0(&_S128, &_S129, _s_dOut_3);

#line 98
                _S126 = Features_x24_syn_dadd_0(_S129.differential_0, _S125);

#line 98
                _S127 = _S128.differential_0;
...
#line 96
            (&_S130)->primal_0 = _S117.primal_0;

#line 96
            (&_S130)->differential_0 = _S124;

#line 96
            DiffPair_Features_0 _S131;

#line 96
            (&_S131)->primal_0 = _S118.primal_0;

#line 96
            (&_S131)->differential_0 = _S125;

#line 96
            s_bwd_prop_eval_sh_col2_0(&_S130, &_S131, _s_dOut_3);

#line 96
            float3  _S132 = _S130.differential_0 + _S127;

#line 96
            _S126 = Features_x24_syn_dadd_0(_S131.differential_0, _S126);
...
#line 94
        (&_S133)->primal_0 = _S117.primal_0;

#line 94
        (&_S133)->differential_0 = _S124;

#line 94
        DiffPair_Features_0 _S134;

#line 94
        (&_S134)->primal_0 = _S118.primal_0;

#line 94
        (&_S134)->differential_0 = _S125;

#line 94
        s_bwd_prop_eval_sh_col1_0(&_S133, &_S134, _s_dOut_3);

#line 94
        float3  _S135 = _S133.differential_0 + _S127;

#line 94
        _S126 = Features_x24_syn_dadd_0(_S134.differential_0, _S126);
...
#line 92
    (&_S136)->primal_0 = _S117.primal_0;

#line 92
    (&_S136)->differential_0 = _S124;

#line 92
    DiffPair_Features_0 _S137;

#line 92
    (&_S137)->primal_0 = _S118.primal_0;

#line 92
    (&_S137)->differential_0 = _S125;

#line 92
    s_bwd_prop_eval_sh_col0_0(&_S136, &_S137, _s_dOut_3);

#line 92
    Features_0 _S138 = Features_x24_syn_dadd_0(_S137.differential_0, _S126);

#line 92
    dpfeat_4->primal_0 = (*dpfeat_4).primal_0;

#line 92
    dpfeat_4->differential_0 = _S138;

#line 92
    float3  _S139 = _S136.differential_0 + _S127;

#line 92
    dpdir_4->primal_0 = (*dpdir_4).primal_0;

#line 92
    dpdir_4->differential_0 = _S139;
...
#line 91
__device__ void s_bwd_eval_color_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * _S140, DiffPair_Features_0 * _S141, uint _S142, float3  _S143)
{

#line 91
    s_bwd_prop_eval_color_0(_S140, _S141, _S142, _S143);
...
#line 47 "E:/projects/multi-view-hair/code/volume_primitive/ever/splinetracers/slang/sh_kernel.slang"
__global__ void __kernel__bw_sh_kernel(TensorView means_1, TensorView features_2, TensorView dL_dfeatures_0, TensorView ray_origin_1, TensorView dL_dcolors_0, uint sh_degree_4)
{

#line 56
    uint prim_ind_2 = (((threadIdx)) + ((blockIdx)) * ((blockDim))).x;
    float _S144 = ((ray_origin_1).load<float>((0U)));

#line 57
    float _S145 = ((ray_origin_1).load<float>((1U)));

#line 57
    float _S146 = ((ray_origin_1).load<float>((2U)));

#line 57
    float3  rayo_1 = make_float3 (_S144, _S145, _S146);

    uint _S147 = ((means_1).sizes[(0U)]);
...
#line 60
    ...
    float3  deriv_color_0 = get_float3_0(dL_dcolors_0, prim_ind_2);

#line 63
    bool _S148;

    if((F32_abs((deriv_color_0.x))) < 9.99999993922529029e-09f)
    {

#line 65
        _S148 = (F32_abs((deriv_color_0.y))) < 9.99999993922529029e-09f;
...
#line 65
        _S148 = (F32_abs((deriv_color_0.z))) < 9.99999993922529029e-09f;
...
#line 66
    ...
    float3  mean_1 = get_float3_0(means_1, prim_ind_2);
    float3  dir_pp_1 = normalize_0(mean_1 - rayo_1);
    Features_0 feat_7 = get_feats_0(features_2, prim_ind_2, sh_degree_4);

    float3  _S149 = make_float3 (0.0f, 0.0f, 0.0f);

#line 73
    DiffPair_vectorx3Cfloatx2C3x3E_0 deriv_direction_0;

#line 73
    (&deriv_direction_0)->primal_0 = dir_pp_1;

#line 73
    (&deriv_direction_0)->differential_0 = _S149;
    Features_0 _S150 = { _S149, _S149, _S149, _S149, _S149, _S149, _S149, _S149, _S149, _S149, _S149, _S149, _S149, _S149, _S149, _S149 };

#line 74
    DiffPair_Features_0 d_feat_0;

#line 74
    (&d_feat_0)->primal_0 = feat_7;

#line 74
    (&d_feat_0)->differential_0 = _S150;
    s_bwd_eval_color_0(&deriv_direction_0, &d_feat_0, sh_degree_4, deriv_color_0);

    add_float3_0(dL_dfeatures_0, prim_ind_2, 0U, d_feat_0.differential_0.f0_0);
    if(sh_degree_4 > 0U)
    {

#line 79
        add_float3_0(dL_dfeatures_0, prim_ind_2, 1U, d_feat_0.differential_0.f1_0);
        add_float3_0(dL_dfeatures_0, prim_ind_2, 2U, d_feat_0.differential_0.f2_0);
        add_float3_0(dL_dfeatures_0, prim_ind_2, 3U, d_feat_0.differential_0.f3_0);
        if(sh_degree_4 > 1U)
        {

#line 83
            add_float3_0(dL_dfeatures_0, prim_ind_2, 4U, d_feat_0.differential_0.f4_0);
            add_float3_0(dL_dfeatures_0, prim_ind_2, 5U, d_feat_0.differential_0.f5_0);
            add_float3_0(dL_dfeatures_0, prim_ind_2, 6U, d_feat_0.differential_0.f6_0);
            add_float3_0(dL_dfeatures_0, prim_ind_2, 7U, d_feat_0.differential_0.f7_0);
            add_float3_0(dL_dfeatures_0, prim_ind_2, 8U, d_feat_0.differential_0.f8_0);
            if(sh_degree_4 > 2U)
            {

#line 89
                add_float3_0(dL_dfeatures_0, prim_ind_2, 9U, d_feat_0.differential_0.f9_0);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 10U, d_feat_0.differential_0.f10_0);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 11U, d_feat_0.differential_0.f11_0);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 12U, d_feat_0.differential_0.f12_0);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 13U, d_feat_0.differential_0.f13_0);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 14U, d_feat_0.differential_0.f14_0);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 15U, d_feat_0.differential_0.f15_0);
