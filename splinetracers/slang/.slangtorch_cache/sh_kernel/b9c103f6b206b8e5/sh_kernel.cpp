...
void __kernel__sh_kernel(TensorView _0, TensorView _1, TensorView _2, TensorView _3, uint32_t _4);


#line 47
SLANG_PRELUDE_EXPORT
void __kernel__bw_sh_kernel(TensorView _0, TensorView _1, TensorView _2, TensorView _3, TensorView _4, uint32_t _5);


#line 47
SLANG_PRELUDE_EXPORT
void sh_kernel(std::tuple<uint32_t, uint32_t, uint32_t> _blockSize_0, std::tuple<uint32_t, uint32_t, uint32_t> _gridSize_0, torch::Tensor means_0, torch::Tensor features_0, torch::Tensor ray_origin_0, torch::Tensor colors_0, uint32_t sh_degree_0)
{
...
#line 47
    TensorView _S3 = make_tensor_view(features_0, "features", torch::kFloat32, false);

#line 47
    TensorView _S4 = make_tensor_view(ray_origin_0, "ray_origin", torch::kFloat32, false);

#line 47
    TensorView _S5 = make_tensor_view(colors_0, "colors", torch::kFloat32, false);

#line 47
    TensorView _S6 = make_tensor_view(means_0, "means", torch::kFloat32, false);

#line 47
    FixedArray<void *, 5>  _S7;
...
#line 47
    uint32_t _S11 = sh_degree_0;

#line 47
    _S7[int(4)] = &_S11;

#line 47
    AT_CUDA_CHECK(cudaLaunchKernel((const void*)(__kernel__sh_kernel), slang_bit_cast<dim3>(_S2), slang_bit_cast<dim3>(_S1), &_S7[int(0)], 0, ((cudaStream_t)at::cuda::getCurrentCUDAStream())));
...
#line 47
SLANG_PRELUDE_EXPORT
static std::tuple<std::tuple<const char*, const char*, const char*, const char*, const char*, const char*, const char*>, std::tuple<const char*, const char*, const char*, const char*, const char*>, const char*, const char*> __funcinfo__sh_kernel()
{

#line 47
    return std::make_tuple(std::make_tuple(Slang::toTerminatedSlice("__blockSize").getBuffer(), Slang::toTerminatedSlice("__gridSize").getBuffer(), Slang::toTerminatedSlice("means").getBuffer(), Slang::toTerminatedSlice("features").getBuffer(), Slang::toTerminatedSlice("ray_origin").getBuffer(), Slang::toTerminatedSlice("colors").getBuffer(), Slang::toTerminatedSlice("sh_degree").getBuffer()), std::make_tuple(Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer()), Slang::toTerminatedSlice(""), Slang::toTerminatedSlice(""));
}


#line 47
SLANG_PRELUDE_EXPORT
void bw_sh_kernel(std::tuple<uint32_t, uint32_t, uint32_t> _blockSize_1, std::tuple<uint32_t, uint32_t, uint32_t> _gridSize_1, torch::Tensor means_1, torch::Tensor features_1, torch::Tensor dL_dfeatures_0, torch::Tensor ray_origin_1, torch::Tensor dL_dcolors_0, uint32_t sh_degree_1)
{

#line 47
    Vector<uint32_t, 3>  _S12 = Vector<uint32_t, 3> (std::get<int(0)>(_blockSize_1), std::get<int(1)>(_blockSize_1), std::get<int(2)>(_blockSize_1));

#line 47
    Vector<uint32_t, 3>  _S13 = Vector<uint32_t, 3> (std::get<int(0)>(_gridSize_1), std::get<int(1)>(_gridSize_1), std::get<int(2)>(_gridSize_1));

#line 47
    TensorView _S14 = make_tensor_view(features_1, "features", torch::kFloat32, false);

#line 47
    TensorView _S15 = make_tensor_view(dL_dfeatures_0, "dL_dfeatures", torch::kFloat32, false);

#line 47
    TensorView _S16 = make_tensor_view(ray_origin_1, "ray_origin", torch::kFloat32, false);

#line 47
    TensorView _S17 = make_tensor_view(dL_dcolors_0, "dL_dcolors", torch::kFloat32, false);

#line 47
    TensorView _S18 = make_tensor_view(means_1, "means", torch::kFloat32, false);

#line 47
    FixedArray<void *, 6>  _S19;

#line 47
    _S19[int(0)] = &_S18;

#line 47
    TensorView _S20 = _S14;

#line 47
    _S19[int(1)] = &_S20;

#line 47
    TensorView _S21 = _S15;

#line 47
    _S19[int(2)] = &_S21;

#line 47
    TensorView _S22 = _S16;

#line 47
    _S19[int(3)] = &_S22;

#line 47
    TensorView _S23 = _S17;

#line 47
    _S19[int(4)] = &_S23;

#line 47
    uint32_t _S24 = sh_degree_1;

#line 47
    _S19[int(5)] = &_S24;

#line 47
    AT_CUDA_CHECK(cudaLaunchKernel((const void*)(__kernel__bw_sh_kernel), slang_bit_cast<dim3>(_S13), slang_bit_cast<dim3>(_S12), &_S19[int(0)], 0, ((cudaStream_t)at::cuda::getCurrentCUDAStream())));
...
#line 47
SLANG_PRELUDE_EXPORT
static std::tuple<std::tuple<const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*>, std::tuple<const char*, const char*, const char*, const char*, const char*, const char*>, const char*, const char*> __funcinfo__bw_sh_kernel()
{

#line 47
    return std::make_tuple(std::make_tuple(Slang::toTerminatedSlice("__blockSize").getBuffer(), Slang::toTerminatedSlice("__gridSize").getBuffer(), Slang::toTerminatedSlice("means").getBuffer(), Slang::toTerminatedSlice("features").getBuffer(), Slang::toTerminatedSlice("dL_dfeatures").getBuffer(), Slang::toTerminatedSlice("ray_origin").getBuffer(), Slang::toTerminatedSlice("dL_dcolors").getBuffer(), Slang::toTerminatedSlice("sh_degree").getBuffer()), std::make_tuple(Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer()), Slang::toTerminatedSlice(""), Slang::toTerminatedSlice(""));
}

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("sh_kernel", &sh_kernel, "sh_kernel");
    m.def("__funcinfo__sh_kernel", &__funcinfo__sh_kernel, "__funcinfo__sh_kernel");
    m.def("bw_sh_kernel", &bw_sh_kernel, "bw_sh_kernel");
    m.def("__funcinfo__bw_sh_kernel", &__funcinfo__bw_sh_kernel, "__funcinfo__bw_sh_kernel");
}
