...
// ============================================================================
// Forward Pass Implementation for OptiX 9.1
// ============================================================================
...
Forward::Forward(const OptixDeviceContext &context, int8_t device,
    ...
    // ========================================================================
    {
        ...
        // 32 payload values for multi-hit sorting
        pipeline_compile_options.numPayloadValues = 32;

        // 1 attribute value for passing other_t in intersection shader
        pipeline_compile_options.numAttributeValues = 1;

        pipeline_compile_options.exceptionFlags = OPTIX_EXCEPTION_FLAG_NONE;

        // Slang generates global parameters with this name
        pipeline_compile_options.pipelineLaunchParamsVariableName =
            "SLANG_globalParams";

        // Custom primitive type for ellipsoid intersection
...

    {
        ...
        // Load OptiX-IR data from embedded arrays
    ...
    // ========================================================================
    {
        ...
        // Hit group (anyhit + intersection, with optional closesthit)
        OptixProgramGroupDesc hitgroup_prog_group_desc = {};
        hitgroup_prog_group_desc.kind = OPTIX_PROGRAM_GROUP_KIND_HITGROUP;

        // Closest hit (can be empty but needed for proper SBT setup)
        hitgroup_prog_group_desc.hitgroup.moduleCH = module;
        hitgroup_prog_group_desc.hitgroup.entryFunctionNameCH = "__closesthit__ch";

        // Any hit for transparency sorting
        hitgroup_prog_group_desc.hitgroup.moduleAH = module;
        hitgroup_prog_group_desc.hitgroup.entryFunctionNameAH = "__anyhit__ah";

        // Custom intersection shader for ellipsoids
