...
static Vector<float, 3>  rotate_vector_0(Vector<float, 3>  v_0, Vector<float, 4>  q_0)
{


    Vector<float, 3>  _S7 = - Vector<float, 3> {q_0.y, q_0.z, q_0.w};

#line 242
    Vector<float, 3>  _S8 = (Vector<float, 3> )2.0f * cross_0(_S7, v_0);
    return v_0 + (Vector<float, 3> )q_0.x * _S8 + cross_0(_S7, _S8);
}
...
void __kernel__backwards_kernel(TensorView _0, TensorView _1, TensorView _2, TensorView _3, TensorView _4, TensorView _5, DualModel_0 _6, TensorView _7, TensorView _8, TensorView _9, TensorView _10, TensorView _11, float _12, float _13, float _14, uint32_t _15);


#line 376
SLANG_PRELUDE_EXPORT
void __kernel__backwards_initial_drgb_kernel(TensorView _0, TensorView _1, DualModel_0 _2, TensorView _3, TensorView _4, TensorView _5, TensorView _6, float _7);


#line 115 "E:/projects/multi-view-hair/code/volume_primitive/ever/splinetracers/fast_ellipsoid_splinetracer/slang/tri-intersect.slang"
static Vector<float, 2>  eliIntersect_0(Vector<float, 3>  ro_0, Vector<float, 3>  rd_0, Vector<float, 3>  ra_0)
{


    Vector<float, 3>  ocn_0 = ro_0 / ra_0;
    Vector<float, 3>  rdn_0 = rd_0 / ra_0;
    float a_0 = dot_0(rdn_0, rdn_0);
    float bp_0 = - dot_0(ocn_0, rdn_0);
    Vector<float, 3>  l_0 = ocn_0 + (Vector<float, 3> )(bp_0 / a_0) * rdn_0;
    float h_0 = a_0 * (1.0f - dot_0(l_0, l_0));
    float c_0 = dot_0(ocn_0, ocn_0) - 1.0f;
    if(h_0 < 0.0f)
    {

#line 126
        return (Vector<float, 2> )-1.0f;
    }

#line 127
    float _S9 = bp_0 + float((F32_sign((bp_0)))) * (F32_sqrt((h_0)));
    return Vector<float, 2> (c_0 / _S9, _S9 / a_0);
}


#line 164
static Vector<float, 2>  ray_intersect_ellipsoid_0(Vector<float, 3>  rayo_0, Vector<float, 3>  rayd_0, Vector<float, 3>  scales_1, Vector<float, 4>  quat_0)
{

#line 173
    Vector<float, 2>  fminmaxt_0 = eliIntersect_0(rotate_vector_0(rayo_0, quat_0), rotate_vector_0(rayd_0, quat_0), scales_1);
    float _S10 = fminmaxt_0.x;

#line 174
    float _S11 = fminmaxt_0.y;

#line 174
    return Vector<float, 2> ((F32_min((_S10), (_S11))), (F32_max((_S10), (_S11))));
}


#line 193
SLANG_PRELUDE_EXPORT
std::tuple<float, float> ray_intersect_ellipsoid_th(std::tuple<float, float, float> rayo_1, std::tuple<float, float, float> rayd_1, std::tuple<float, float, float> scales_2, std::tuple<float, float, float, float> quat_1)
{



    Vector<float, 2>  _S12 = ray_intersect_ellipsoid_0(Vector<float, 3> (std::get<int(0)>(rayo_1), std::get<int(1)>(rayo_1), std::get<int(2)>(rayo_1)), Vector<float, 3> (std::get<int(0)>(rayd_1), std::get<int(1)>(rayd_1), std::get<int(2)>(rayd_1)), Vector<float, 3> (std::get<int(0)>(scales_2), std::get<int(1)>(scales_2), std::get<int(2)>(scales_2)), Vector<float, 4> (std::get<int(0)>(quat_1), std::get<int(1)>(quat_1), std::get<int(2)>(quat_1), std::get<int(3)>(quat_1)));

#line 199
    return std::make_tuple(_S12.x, _S12.y);
}


#line 199
SLANG_PRELUDE_EXPORT
void backwards_kernel(std::tuple<uint32_t, uint32_t, uint32_t> _blockSize_0, std::tuple<uint32_t, uint32_t, uint32_t> _gridSize_0, torch::Tensor last_state_0, torch::Tensor last_dirac_0, torch::Tensor iters_0, torch::Tensor tri_collection_0, torch::Tensor ray_origins_0, torch::Tensor ray_directions_0, std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor> model_0, torch::Tensor initial_drgb_0, torch::Tensor dL_dinital_drgb_0, torch::Tensor touch_count_0, torch::Tensor dL_doutputs_0, torch::Tensor wcts_0, float tmin_0, float tmax_0, float max_prim_size_0, uint32_t max_iters_0)
{

#line 199
    Vector<uint32_t, 3>  _S13 = Vector<uint32_t, 3> (std::get<int(0)>(_blockSize_0), std::get<int(1)>(_blockSize_0), std::get<int(2)>(_blockSize_0));

#line 199
    Vector<uint32_t, 3>  _S14 = Vector<uint32_t, 3> (std::get<int(0)>(_gridSize_0), std::get<int(1)>(_gridSize_0), std::get<int(2)>(_gridSize_0));

#line 199
    TensorView _S15 = make_tensor_view(last_dirac_0, "last_dirac", torch::kFloat32, false);

#line 199
    TensorView _S16 = make_tensor_view(iters_0, "iters", torch::kInt32, false);

#line 199
    TensorView _S17 = make_tensor_view(tri_collection_0, "tri_collection", torch::kInt32, false);

#line 199
    TensorView _S18 = make_tensor_view(ray_origins_0, "ray_origins", torch::kFloat32, false);

#line 199
    TensorView _S19 = make_tensor_view(ray_directions_0, "ray_directions", torch::kFloat32, false);

#line 199
    TensorView _S20 = make_tensor_view(std::get<int(0)>(model_0), "model_means", torch::kFloat32, false);

#line 199
    TensorView _S21 = make_tensor_view(std::get<int(1)>(model_0), "model_scales", torch::kFloat32, false);

#line 199
    TensorView _S22 = make_tensor_view(std::get<int(2)>(model_0), "model_quats", torch::kFloat32, false);

#line 199
    TensorView _S23 = make_tensor_view(std::get<int(3)>(model_0), "model_densities", torch::kFloat32, false);

#line 199
    TensorView _S24 = make_tensor_view(std::get<int(4)>(model_0), "model_features", torch::kFloat32, false);

#line 199
    TensorView _S25 = make_tensor_view(std::get<int(5)>(model_0), "model_dL_dmeans", torch::kFloat32, false);

#line 199
    TensorView _S26 = make_tensor_view(std::get<int(6)>(model_0), "model_dL_dscales", torch::kFloat32, false);

#line 199
    TensorView _S27 = make_tensor_view(std::get<int(7)>(model_0), "model_dL_dquats", torch::kFloat32, false);

#line 199
    TensorView _S28 = make_tensor_view(std::get<int(8)>(model_0), "model_dL_ddensities", torch::kFloat32, false);

#line 199
    TensorView _S29 = make_tensor_view(std::get<int(9)>(model_0), "model_dL_dfeatures", torch::kFloat32, false);

#line 199
    TensorView _S30 = make_tensor_view(std::get<int(10)>(model_0), "model_dL_drayos", torch::kFloat32, false);

#line 199
    TensorView _S31 = make_tensor_view(std::get<int(11)>(model_0), "model_dL_drayds", torch::kFloat32, false);

#line 199
    TensorView _S32 = make_tensor_view(std::get<int(12)>(model_0), "model_dL_dmeans2D", torch::kFloat32, false);

#line 199
    TensorView _S33 = make_tensor_view(initial_drgb_0, "initial_drgb", torch::kFloat32, false);

#line 199
    TensorView _S34 = make_tensor_view(dL_dinital_drgb_0, "dL_dinital_drgb", torch::kFloat32, false);

#line 199
    TensorView _S35 = make_tensor_view(touch_count_0, "touch_count", torch::kInt32, false);

#line 199
    TensorView _S36 = make_tensor_view(dL_doutputs_0, "dL_doutputs", torch::kFloat32, false);

#line 199
    TensorView _S37 = make_tensor_view(wcts_0, "wcts", torch::kFloat32, false);

#line 199
    TensorView _S38 = make_tensor_view(last_state_0, "last_state", torch::kFloat32, false);

#line 199
    FixedArray<void *, 16>  _S39;

#line 199
    _S39[int(0)] = &_S38;

#line 199
    TensorView _S40 = _S15;

#line 199
    _S39[int(1)] = &_S40;

#line 199
    TensorView _S41 = _S16;

#line 199
    _S39[int(2)] = &_S41;

#line 199
    TensorView _S42 = _S17;

#line 199
    _S39[int(3)] = &_S42;

#line 199
    TensorView _S43 = _S18;

#line 199
    _S39[int(4)] = &_S43;

#line 199
    TensorView _S44 = _S19;
...
#line 199
    (&_S45)->densities_0 = _S23;

#line 199
    (&_S45)->features_0 = _S24;

#line 199
    (&_S45)->dL_dmeans_0 = _S25;

#line 199
    (&_S45)->dL_dscales_0 = _S26;

#line 199
    (&_S45)->dL_dquats_0 = _S27;

#line 199
    (&_S45)->dL_ddensities_0 = _S28;

#line 199
    (&_S45)->dL_dfeatures_0 = _S29;

#line 199
    (&_S45)->dL_drayos_0 = _S30;

#line 199
    (&_S45)->dL_drayds_0 = _S31;

#line 199
    (&_S45)->dL_dmeans2D_0 = _S32;

#line 199
    _S39[int(6)] = &_S45;

#line 199
    TensorView _S46 = _S33;

#line 199
    _S39[int(7)] = &_S46;

#line 199
    TensorView _S47 = _S34;

#line 199
    _S39[int(8)] = &_S47;

#line 199
    TensorView _S48 = _S35;

#line 199
    _S39[int(9)] = &_S48;

#line 199
    TensorView _S49 = _S36;

#line 199
    _S39[int(10)] = &_S49;

#line 199
    TensorView _S50 = _S37;
...
#line 199
    float _S53 = max_prim_size_0;

#line 199
    _S39[int(14)] = &_S53;

#line 199
    uint32_t _S54 = max_iters_0;

#line 199
    _S39[int(15)] = &_S54;

#line 199
    AT_CUDA_CHECK(cudaLaunchKernel((const void*)(__kernel__backwards_kernel), slang_bit_cast<dim3>(_S14), slang_bit_cast<dim3>(_S13), &_S39[int(0)], 0, ((cudaStream_t)at::cuda::getCurrentCUDAStream())));
...
#line 199
SLANG_PRELUDE_EXPORT
static std::tuple<std::tuple<const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*>, std::tuple<const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*>, const char*, const char*> __funcinfo__backwards_kernel()
{

#line 199
    return std::make_tuple(std::make_tuple(Slang::toTerminatedSlice("__blockSize").getBuffer(), Slang::toTerminatedSlice("__gridSize").getBuffer(), Slang::toTerminatedSlice("last_state").getBuffer(), Slang::toTerminatedSlice("last_dirac").getBuffer(), Slang::toTerminatedSlice("iters").getBuffer(), Slang::toTerminatedSlice("tri_collection").getBuffer(), Slang::toTerminatedSlice("ray_origins").getBuffer(), Slang::toTerminatedSlice("ray_directions").getBuffer(), Slang::toTerminatedSlice("model").getBuffer(), Slang::toTerminatedSlice("initial_drgb").getBuffer(), Slang::toTerminatedSlice("dL_dinital_drgb").getBuffer(), Slang::toTerminatedSlice("touch_count").getBuffer(), Slang::toTerminatedSlice("dL_doutputs").getBuffer(), Slang::toTerminatedSlice("wcts").getBuffer(), Slang::toTerminatedSlice("tmin").getBuffer(), Slang::toTerminatedSlice("tmax").getBuffer(), Slang::toTerminatedSlice("max_prim_size").getBuffer(), Slang::toTerminatedSlice("max_iters").getBuffer()), std::make_tuple(Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("DualModel").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer()), Slang::toTerminatedSlice(""), Slang::toTerminatedSlice(""));
}


#line 199
SLANG_PRELUDE_EXPORT
void backwards_initial_drgb_kernel(std::tuple<uint32_t, uint32_t, uint32_t> _blockSize_1, std::tuple<uint32_t, uint32_t, uint32_t> _gridSize_1, torch::Tensor ray_origins_1, torch::Tensor ray_directions_1, std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor> model_1, torch::Tensor initial_drgb_1, torch::Tensor initial_inds_0, torch::Tensor dL_dinital_drgb_1, torch::Tensor touch_count_1, float tmin_1)
{

#line 199
    Vector<uint32_t, 3>  _S55 = Vector<uint32_t, 3> (std::get<int(0)>(_blockSize_1), std::get<int(1)>(_blockSize_1), std::get<int(2)>(_blockSize_1));

#line 199
    Vector<uint32_t, 3>  _S56 = Vector<uint32_t, 3> (std::get<int(0)>(_gridSize_1), std::get<int(1)>(_gridSize_1), std::get<int(2)>(_gridSize_1));

#line 199
    TensorView _S57 = make_tensor_view(ray_directions_1, "ray_directions", torch::kFloat32, false);

#line 199
    TensorView _S58 = make_tensor_view(std::get<int(0)>(model_1), "model_means", torch::kFloat32, false);

#line 199
    TensorView _S59 = make_tensor_view(std::get<int(1)>(model_1), "model_scales", torch::kFloat32, false);

#line 199
    TensorView _S60 = make_tensor_view(std::get<int(2)>(model_1), "model_quats", torch::kFloat32, false);

#line 199
    TensorView _S61 = make_tensor_view(std::get<int(3)>(model_1), "model_densities", torch::kFloat32, false);

#line 199
    TensorView _S62 = make_tensor_view(std::get<int(4)>(model_1), "model_features", torch::kFloat32, false);

#line 199
    TensorView _S63 = make_tensor_view(std::get<int(5)>(model_1), "model_dL_dmeans", torch::kFloat32, false);

#line 199
    TensorView _S64 = make_tensor_view(std::get<int(6)>(model_1), "model_dL_dscales", torch::kFloat32, false);

#line 199
    TensorView _S65 = make_tensor_view(std::get<int(7)>(model_1), "model_dL_dquats", torch::kFloat32, false);

#line 199
    TensorView _S66 = make_tensor_view(std::get<int(8)>(model_1), "model_dL_ddensities", torch::kFloat32, false);

#line 199
    TensorView _S67 = make_tensor_view(std::get<int(9)>(model_1), "model_dL_dfeatures", torch::kFloat32, false);

#line 199
    TensorView _S68 = make_tensor_view(std::get<int(10)>(model_1), "model_dL_drayos", torch::kFloat32, false);

#line 199
    TensorView _S69 = make_tensor_view(std::get<int(11)>(model_1), "model_dL_drayds", torch::kFloat32, false);

#line 199
    TensorView _S70 = make_tensor_view(std::get<int(12)>(model_1), "model_dL_dmeans2D", torch::kFloat32, false);

#line 199
    TensorView _S71 = make_tensor_view(initial_drgb_1, "initial_drgb", torch::kFloat32, false);

#line 199
    TensorView _S72 = make_tensor_view(initial_inds_0, "initial_inds", torch::kInt32, false);

#line 199
    TensorView _S73 = make_tensor_view(dL_dinital_drgb_1, "dL_dinital_drgb", torch::kFloat32, false);

#line 199
    TensorView _S74 = make_tensor_view(touch_count_1, "touch_count", torch::kInt32, false);

#line 199
    TensorView _S75 = make_tensor_view(ray_origins_1, "ray_origins", torch::kFloat32, false);

#line 199
    FixedArray<void *, 8>  _S76;

#line 199
    _S76[int(0)] = &_S75;

#line 199
    TensorView _S77 = _S57;
...
#line 199
    (&_S78)->densities_0 = _S61;

#line 199
    (&_S78)->features_0 = _S62;

#line 199
    (&_S78)->dL_dmeans_0 = _S63;

#line 199
    (&_S78)->dL_dscales_0 = _S64;

#line 199
    (&_S78)->dL_dquats_0 = _S65;

#line 199
    (&_S78)->dL_ddensities_0 = _S66;

#line 199
    (&_S78)->dL_dfeatures_0 = _S67;

#line 199
    (&_S78)->dL_drayos_0 = _S68;

#line 199
    (&_S78)->dL_drayds_0 = _S69;

#line 199
    (&_S78)->dL_dmeans2D_0 = _S70;

#line 199
    _S76[int(2)] = &_S78;

#line 199
    TensorView _S79 = _S71;

#line 199
    _S76[int(3)] = &_S79;

#line 199
    TensorView _S80 = _S72;

#line 199
    _S76[int(4)] = &_S80;

#line 199
    TensorView _S81 = _S73;

#line 199
    _S76[int(5)] = &_S81;

#line 199
    TensorView _S82 = _S74;
...
#line 199
    AT_CUDA_CHECK(cudaLaunchKernel((const void*)(__kernel__backwards_initial_drgb_kernel), slang_bit_cast<dim3>(_S56), slang_bit_cast<dim3>(_S55), &_S76[int(0)], 0, ((cudaStream_t)at::cuda::getCurrentCUDAStream())));
...
#line 199
SLANG_PRELUDE_EXPORT
static std::tuple<std::tuple<const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*>, std::tuple<const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*>, const char*, const char*> __funcinfo__backwards_initial_drgb_kernel()
{

#line 199
    return std::make_tuple(std::make_tuple(Slang::toTerminatedSlice("__blockSize").getBuffer(), Slang::toTerminatedSlice("__gridSize").getBuffer(), Slang::toTerminatedSlice("ray_origins").getBuffer(), Slang::toTerminatedSlice("ray_directions").getBuffer(), Slang::toTerminatedSlice("model").getBuffer(), Slang::toTerminatedSlice("initial_drgb").getBuffer(), Slang::toTerminatedSlice("initial_inds").getBuffer(), Slang::toTerminatedSlice("dL_dinital_drgb").getBuffer(), Slang::toTerminatedSlice("touch_count").getBuffer(), Slang::toTerminatedSlice("tmin").getBuffer()), std::make_tuple(Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("DualModel").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer()), Slang::toTerminatedSlice(""), Slang::toTerminatedSlice(""));
}


#line 199
SLANG_PRELUDE_EXPORT
static std::tuple<std::tuple<const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*>, std::tuple<const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*>> __typeinfo__DualModel()
{

#line 199
    return std::make_tuple(std::make_tuple(Slang::toTerminatedSlice("means").getBuffer(), Slang::toTerminatedSlice("scales").getBuffer(), Slang::toTerminatedSlice("quats").getBuffer(), Slang::toTerminatedSlice("densities").getBuffer(), Slang::toTerminatedSlice("features").getBuffer(), Slang::toTerminatedSlice("dL_dmeans").getBuffer(), Slang::toTerminatedSlice("dL_dscales").getBuffer(), Slang::toTerminatedSlice("dL_dquats").getBuffer(), Slang::toTerminatedSlice("dL_ddensities").getBuffer(), Slang::toTerminatedSlice("dL_dfeatures").getBuffer(), Slang::toTerminatedSlice("dL_drayos").getBuffer(), Slang::toTerminatedSlice("dL_drayds").getBuffer(), Slang::toTerminatedSlice("dL_dmeans2D").getBuffer()), std::make_tuple(Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer(), Slang::toTerminatedSlice("").getBuffer()));
}

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("ray_intersect_ellipsoid_th", &ray_intersect_ellipsoid_th, "ray_intersect_ellipsoid_th");
    m.def("backwards_kernel", &backwards_kernel, "backwards_kernel");
    m.def("__funcinfo__backwards_kernel", &__funcinfo__backwards_kernel, "__funcinfo__backwards_kernel");
    m.def("backwards_initial_drgb_kernel", &backwards_initial_drgb_kernel, "backwards_initial_drgb_kernel");
    m.def("__funcinfo__backwards_initial_drgb_kernel", &__funcinfo__backwards_initial_drgb_kernel, "__funcinfo__backwards_initial_drgb_kernel");
    m.def("__typeinfo__DualModel", &__typeinfo__DualModel, "__typeinfo__DualModel");
}
